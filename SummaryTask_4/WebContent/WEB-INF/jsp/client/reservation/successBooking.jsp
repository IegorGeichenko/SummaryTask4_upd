				...
				<div class="room">
					<div>
						<p
							...
							<fmt:message key="success.booking"/></p>
						...
						<p>
							<a style="display: block; background-color: #32A2E3; -webkit-background-size: 70px 25px !important; color: white; margin-top: 50px; margin-right: 470px; margin-left: 470px;"
